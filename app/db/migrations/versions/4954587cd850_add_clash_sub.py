...
Revision ID: 4954587cd850
Revises: 2b231de97dc3
Create Date: 2025-04-20 09:40:35.661252
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_clash_links_id'), 'clash_links', ['id'], unique=False)
    op.create_index(op.f('ix_clash_links_name'), 'clash_links', ['name'], unique=False)
    op.create_index(op.f('ix_clash_links_tag'), 'clash_links', ['tag'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_clash_links_tag'), table_name='clash_links')
    op.drop_index(op.f('ix_clash_links_name'), table_name='clash_links')
    op.drop_index(op.f('ix_clash_links_id'), table_name='clash_links')
    op.drop_table('clash_links')
    # ### end Alembic commands ###
...
def insert_proxy_groups():
    data = [
        ...
        {"id": 5, "name": "🔰 Ping", "tag": "built-in", "type": "load-balance", "builtin": True, "proxies": "...", "settings": {"load_balance": {"strategy": "consistent-hashing", "url": "http://www.gstatic.com/generate_204", "interval": 300}}},
    ]
    for item in data:
        item["modified_at"] = datetime.utcnow()

    op.bulk_insert(ClashProxyGroup.__table__, data)
...
def insert_rulesets():
    ...
    for ruleset in rulesets:
        id += 1
        op.bulk_insert(ClashRuleset.__table__, [
            {
                "id": id,
                "name": ruleset["name"],
        ...
        op.bulk_insert(ClashRule.__table__, rules)
