...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_clash_profiles_id'), 'clash_links', ['id'], unique=False)
    op.create_index(op.f('ix_clash_profiles_name'), 'clash_links', ['name'], unique=False)
    op.create_index(op.f('ix_clash_profiles_tag'), 'clash_links', ['tag'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_clash_profiles_tag'), table_name='clash_links')
    op.drop_index(op.f('ix_clash_profiles_name'), table_name='clash_links')
    op.drop_index(op.f('ix_clash_profiles_id'), table_name='clash_links')
